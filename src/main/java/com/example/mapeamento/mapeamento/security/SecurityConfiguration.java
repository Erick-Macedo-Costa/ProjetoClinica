package com.example.mapeamento.mapeamento.security;
        ...
        http.authorizeHttpRequests(
                        customizer ->
                                customizer
                                        ...
                                        .requestMatchers("/consultas/form").hasAnyRole("ERICK", "MEDICO")
                                        .requestMatchers("/consultas/list").hasAnyRole("ERICK", "RECPCAO", "MEDICO")
                                        .requestMatchers("/medicos/form").hasAnyRole("ERICK", "MEDICO")
                                        .requestMatchers("/pacientes/form").hasAnyRole("ERICK", "RECPCAO")
                                        .requestMatchers("/pacientes/list").hasAnyRole("ERICK", "RECPCAO", "MEDICO")
